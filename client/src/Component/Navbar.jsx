...
const Navbar = () => {
  ...
  return (
    <div className="flex w-full  bg-white dark:bg-slate-800 h-full  relative shadow">
      <div className="flex w-full justify-between p-4 md:p-2 md:items-center md:px-4">
        ...
        <div className="lg:flex gap-6 justify-between items-center hidden">
          <NavLink to="/" className="dark:text-slate-200   py-3 ">
            Home
          </NavLink>
          <NavLink to="/service" className="dark:text-slate-200   py-3 ">
            Service
          </NavLink>
          <NavLink to="/pricing" className="dark:text-slate-200   py-3">
            Pricing
          </NavLink>
          <button
      ...
      <div
        className=" justify-center absolute mt-16 bg-stone-50 z-50 dark:bg-slate-900 gap-y-2 h-[300px] w-screen items-center flex-col lg:hidden"
        style={{ display: openToggle ? "flex" : "none" }}
      >
        <NavLink to="/" className=" px-12  py-3 dark:text-slate-200 ">
          Home
        </NavLink>
        <NavLink to="/service" className=" px-12  py-3 dark:text-slate-200">
          Service
        </NavLink>
        <NavLink to="/pricing" className=" px-12  py-3 dark:text-slate-200">
          Pricing
        </NavLink>
        <button
